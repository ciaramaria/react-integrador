...
const Stories = ({ story: { title, news } }) => {
  ...
  return (
    <>
      <div className="pumba-container mb-11 ">
        <Title title={title} />
        <div className="mt-7">
                ...
                <div className="relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200">
                  ...
                  <div className="flex items-center justify-between w-full px-4">
                    <div className="flex items-center gap-0.5">
                      ...
                      <span className="text-xs font-bold text-slate-800">{val.like}</span>
                    </div>
                    <div className="flex items-center gap-0.5 ">
                      <ClockIcon className="icon-style w-4 h-4 text-black" />
                      <span className="text-xs font-bold text-slate-800">{val.time}</span>
                    </div>
                    <div className="flex items-center gap-0.5">
                  ...
                  <div className="grid items-center justify-items-start px-4">
                    <h1 className="text-base font-semibold lg:text-sm text-slate-950">{val.title}</h1>
                    <p className="text-sm text-justify lg:text-xs  text-slate-800">{truncate(val.text, {length: 175})}</p>
                  </div>
