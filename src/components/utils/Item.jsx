     ...
     <div
      ...
      >
        ...
        <div className='flex items-center gap-3'>
          ...
          <button type='button' className='bg-white/90 blur-effect-theme button-theme px-2 py-1 shadow shadow-sky-200'>{btn}</button>
        </div>

      </div>

      <div className='flex items-center'>
        <img src={img} alt="img/item-img" className='h-36 w-50 transitions-theme hover:rotate-3'/>
      </div>
